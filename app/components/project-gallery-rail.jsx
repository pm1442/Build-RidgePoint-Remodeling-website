...
export function ProjectGalleryRail({ images }) {
  ...
  return <div className="project-gallery-rail-wrap">
    <div className="project-gallery-rail-stage">
      <div className="project-gallery-rail" ref={railRef} aria-label="Kitchen inspiration gallery">
      ...
      <button aria-label="View previous kitchen image" className="project-gallery-rail-nav project-gallery-rail-nav-previous" onClick={() => moveToImage((activeIndex - 1 + images.length) % images.length)} type="button"><span aria-hidden="true">←</span></button>
      <button aria-label="View next kitchen image" className="project-gallery-rail-nav project-gallery-rail-nav-next" onClick={() => moveToImage((activeIndex + 1) % images.length)} type="button"><span aria-hidden="true">→</span></button>
    </div>
    <div className="project-gallery-rail-controls" aria-label="Kitchen gallery controls">
