...
export default function AreasPage() {
  return <PageFrame><section className="page-hero shell"><p className="eyebrow">Service area</p><h1>Serving Lake Butler and North Florida.</h1><p>RidgePoint works with homeowners in Lake Butler and throughout North Florida, including rural communities. Reach out with your project and location to confirm availability.</p></section><section className="section shell"><div className="city-grid">{site.cities.map((city) => <div key={city}>{city}, FL</div>)}</div></section></PageFrame>;
}
