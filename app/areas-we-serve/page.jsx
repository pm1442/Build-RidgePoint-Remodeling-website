...
export const metadata = {
  ...
  description: "RidgePoint Remodeling & Carpentry is based in Lake Butler and serves homeowners within roughly a 60-minute drive across nearby North Florida communities.",
  alternates: { canonical: "/areas-we-serve" },
};

const localAnswers = [
  { question: "Do you serve Gainesville?", answer: "Yes. RidgePoint serves Gainesville and nearby communities when the project scope and schedule are a fit. Share your location and the work you have in mind so Jason can confirm availability." },
  { question: "How far from Lake Butler do you travel?", answer: "RidgePoint typically serves homeowners within roughly a 60-minute drive of Lake Butler. Travel time, project scope, and scheduling all matter, so availability is confirmed before work is scheduled." },
  { question: "What remodeling projects does RidgePoint handle?", answer: "RidgePoint discusses kitchen and bathroom renovations, cabinet sales and installation, custom carpentry, trim, flooring, siding, windows, and deck additions." },
];
...
export default function AreasPage() {
  return <PageFrame>
    ...
    <section className="section section-soft"><div className="shell faq-grid"><div><p className="eyebrow">Local questions</p><h2>Clear answers before you reach out.</h2><p>RidgePoint is based in Lake Butler and plans projects with the actual location, scope, and schedule in mind.</p></div><div>{localAnswers.map((faq) => <details key={faq.question}><summary>{faq.question}</summary><p>{faq.answer}</p></details>)}</div></div></section>
