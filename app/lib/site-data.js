...
export const services = [
  ...
  },
  {
    ...
    scopeItems: [
      { title: "Forevermark Cabinetry through Matrix Cabinets", text: "RidgePoint is a dealer for Forevermark Cabinetry, supplied through Matrix Cabinets. Cabinet collections offer different door styles, finishes, and construction details to fit the room and look you want." },
    ...
    serviceFaqs: [
      { question: "Which cabinet brand does RidgePoint offer?", answer: "RidgePoint is a dealer for Forevermark Cabinetry, supplied through Matrix Cabinets. Jason can help you discuss the available collections, finishes, and cabinet options that fit your room and project." },
      ...
      { question: "What construction features do Forevermark cabinets have?", answer: "Construction details vary by collection. Matrix's current Forevermark specifications list features such as 1/2-inch plywood cabinet boxes, 3/4-inch shelves, dovetail wood drawer boxes, full-extension soft-close drawer glides, and concealed soft-close door hinges. Jason can confirm the exact spec sheet for the collection you choose." },
