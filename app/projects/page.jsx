...
export default function ProjectsPage() {
  const galleries = [
    { id: "kitchens-and-cabinetry", title: "Kitchens and cabinetry", copy: "Cabinet layouts, storage, and finish details that support everyday use.", images: [["/images/rpr-jasons-kitchen-final.png", "Completed kitchen remodel in Lake Butler, Florida, with white cabinetry, pendant lighting, and a central island", "New Kitchen Remodel in Lake Butler, Florida. Completed January 2026."], ["/images/rpr-new-kitchen-lake-butler.jpg", "Brand new white kitchen by RidgePoint Remodeling & Carpentry in Lake Butler, Florida"], ["/images/kitchen-gallery-02.png", "Finished kitchen with light cabinets, stainless appliances, and a window over the sink"], ["/images/kitchen-gallery-03.png", "Open kitchen with a green island, pendant lights, and natural wood flooring"], ["/images/kitchen-gallery-04.jpg", "White kitchen with a marble-look island and stainless appliances"]] },
